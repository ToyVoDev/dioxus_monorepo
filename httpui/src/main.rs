...
fn App() -> Element {
    ...
    let requests = use_signal(|| vec![
        Request {
            id: 1, collection_id: Some(1), name: "Login User".into(), method: "POST".into(),
            url: "https://api.example.com/v1/auth/login".into(),
            headers: vec![], params: vec![], body: None,
            inherit_cookies_header: false, inherit_authorization_header: false,
        },
        Request {
            id: 2, collection_id: Some(1), name: "Get User Profile".into(), method: "GET".into(),
            url: "https://api.example.com/v1/users/me".into(),
            headers: vec![],
            params: vec![KeyValue { id: 1, key: "api_version".into(), value: "2024-09-01".into(), description: "API version".into(), enabled: true }],
            body: None,
            inherit_cookies_header: false, inherit_authorization_header: false,
        },
        Request {
            id: 3, collection_id: Some(1), name: "Reset Password".into(), method: "PUT".into(),
            url: "https://api.example.com/v1/auth/reset".into(),
            headers: vec![], params: vec![], body: None,
            inherit_cookies_header: false, inherit_authorization_header: false,
        },
        Request {
            id: 4, collection_id: Some(2), name: "List Invoices".into(), method: "GET".into(),
            url: "https://api.example.com/v1/billing/invoices".into(),
            headers: vec![], params: vec![], body: None,
            inherit_cookies_header: false, inherit_authorization_header: false,
        },
        Request {
            id: 5, collection_id: Some(2), name: "Delete Invoice".into(), method: "DELETE".into(),
