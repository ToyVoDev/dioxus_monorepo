                ...
                div { class: "now-playing__layout",
                    ...
                    div { class: "now-playing__left",
                        div { class: "now-playing__art",
                            "{track.title.chars().next().unwrap_or('?')}"
                        }
                        ...
                        div { class: "now-playing__progress",
                            ...
                            span { "{format_duration(track.duration_secs)}" }
                        }
                    ...
                    div { class: "now-playing__right",
                        ...
                        div { class: "now-playing__bento",
                            div { class: "now-playing__bento-card",
                                ...
                                span { class: "now-playing__bento-card__value", "{track.album}" }
                            }
                            div { class: "now-playing__bento-card",
                                span { class: "now-playing__bento-card__label", "Genre" }
                                {
                                    let genre_display = if track.genre.is_empty() { "Unknown".to_string() } else { track.genre.clone() };
                                    rsx! {
                                        span { class: "now-playing__bento-card__value", "{genre_display}" }
                                    }
                                }
                            }
                            div { class: "now-playing__bento-card",
                                span { class: "now-playing__bento-card__label", "Duration" }
                                span { class: "now-playing__bento-card__value", "{format_duration(track.duration_secs)}" }
                            }
                        }
                                ...
                                for (i, q_track) in queue.iter().enumerate() {
                                    {
                                        ...
                                        rsx! {
                                            div {
                                                ...
                                                span { class: "now-playing__queue-item__title", "{q_track.title}" }
                                                span { class: "now-playing__queue-item__duration", "{format_duration(q_track.duration_secs)}" }
                                            }
                                        }
                                    }
                                }
