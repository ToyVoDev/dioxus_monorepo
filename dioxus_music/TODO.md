...
- [x] **4. Downloads/Sync Manager** — Storage breakdown, download queue, transcoding settings, synced library grid. Design from scratch (Stitch mockup was bad). Reference `downloads_sync/code.html` for intended content, ignore layout. Mostly future feature work — placeholder UI
